\hypertarget{interface_a_r_video_background}{\section{A\-R\-Video\-Background Class Reference}
\label{interface_a_r_video_background}\index{A\-R\-Video\-Background@{A\-R\-Video\-Background}}
}
...
\hypertarget{interface_a_r_video_background_a912dbfd42208bacb82411d537e80c8b9}{\index{A\-R\-Video\-Background@{A\-R\-Video\-Background}!update\-:@{update\-:}}
\index{update\-:@{update\-:}!ARVideoBackground@{A\-R\-Video\-Background}}
\subsubsection[{update\-:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (void) {\bf update\-:} 
\begin{DoxyParamCaption}
\item[{({\bf A\-R\-Video\-Frame} $\ast$)}]{frame}
...
\item 
A\-R\-Video\-Background.\-h\end{DoxyCompactItemize}
